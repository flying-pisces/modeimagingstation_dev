...
tube_lens_length = 0;        // mm, physical length of TTL200-S8 tube lens (adjust to actual)
profiler_length = 0;         // mm, estimated for beam profiler
tube_to_camera_flange = 0;  // mm, optical spacing: tube lens rear face to camera flange
